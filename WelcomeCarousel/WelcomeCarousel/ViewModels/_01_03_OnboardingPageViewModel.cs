...
{
    public class _01_03_OnboardingPageViewModel : ViewModelBase
    {
        ...
        public _01_03_OnboardingPageViewModel(INavigationService navigationService) : base(navigationService)
        {
        ...
        {
            await _navigationService.NavigateAsync("_01_04_OnboardingPage");
        }
